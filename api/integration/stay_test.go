...
func sampleStay1(eventName string) imsjson.Stay {
	return imsjson.Stay{
		...
		GuestDescription:     ptr("Tall very large guy"),
		GuestCampName:        ptr("Ranch Camp"),
		GuestCampAddress:     ptr("7:00 & A"),
		GuestCampDescription: ptr("Lots of bison out front"),

		ArrivalTime:       ptr(time.Unix(1769599609, 0)),
		ArrivalMethod:     ptr("stomped in"),
		ArrivalState:      ptr("seemed angry"),
		ArrivalReason:     ptr("needed a place to chill"),
		ArrivalBelongings: ptr("bison costume"),

		DepartureTime:   ptr(time.Unix(1769617607, 0)),
		DepartureMethod: ptr("stomped out"),
		DepartureState:  ptr("happily eating some grass"),

		ResourceRest:    ptr("slept in the quonset; needed literally all the space"),
		ResourceClothes: ptr("gave him some diapers"),
		ResourcePogs:    ptr("no, wasn't hungry"),
		ResourceFoodBev: ptr("ate a lot of our grass"),
		ResourceOther:   ptr("nothing else"),
...
func TestCreateAndUpdateStay(t *testing.T) {
	...
	updates = imsjson.Stay{
		...
		GuestCampName:        ptr(""),
		GuestCampAddress:     ptr(""),
		GuestCampDescription: ptr(""),
		ArrivalTime:          &time.Time{},
		ArrivalMethod:        ptr(""),
		ArrivalState:         ptr(""),
		ArrivalReason:        ptr(""),
		ArrivalBelongings:    ptr(""),
