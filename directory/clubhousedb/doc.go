...
// Package clubhousedb holds the sqlc-generated accessors for the Ranger
// Clubhouse database. It is generated from directory/queries.sql and
// directory/schema/current.sql.
//
