...
func Root(deployment, versionName, versionRef string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<p class=\"mt-3 if-logged-in hidden\"><a id=\"current-year-link\" href=\"/ims/app/events/2026/incidents\">Jump to the 2026 event</a> or select another event from the dropdown above.</p><div class=\"mt-3 if-logged-in hidden\"><p>Summary of what's new in 2026:</p><ul><li>Location names/addresses can be autopopulated using official camp/art/MV data</li><li>Ranger \"roles\" can be set on Incidents, indicating how each Ranger was involved</li><li>Incidents may now be linked together, even across years, to permit easier navigation between related Incidents</li><li>Green Dots can now track all Sanctuary Visit information inside IMS, and can attach Visits to Incidents</li></ul></div><div class=\"btn-group mb-3\" role=\"group\"><a id=\"login-button\" href=\"/ims/auth/login\" role=\"button\" class=\"btn btn-md btn-default btn-primary if-not-logged-in hidden\">Log In</a></div><div class=\"btn-group mb-3\" role=\"group\"><a href=\"/ims/auth/logout\" role=\"button\" class=\"btn btn-md btn-default btn-danger if-logged-in hidden\">Log Out</a></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
