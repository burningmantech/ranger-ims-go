...
func Root(deployment, versionName, versionRef string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<h1 id=\"doc-title\">Incident Management System</h1><p class=\"mt-3 if-logged-in hidden\"><a id=\"current-year-link\" href=\"/ims/app/events/2025/incidents\">Jump to the 2025 event</a> or select another event from the dropdown above.</p><div class=\"mt-3 mb-3 if-logged-in hidden\"><h5>Session Preferences (beta)</h5><div class=\"py-1\"><div class=\"input-group mb-1 flex-nowrap\"><label class=\"control-label input-group-text\" for=\"preferred_state\" title=\"The default filter view for the Incidents table\">State filter</label> <select id=\"preferred_state\" class=\"form-control form-select form-select-sm\" onchange=\"setPreferredState(this)\" style=\"max-width: 150px;\"><option value=\"none\" selected>Use Default</option> <option value=\"all\">All Incidents</option> <option value=\"open\">Open Incidents</option> <option value=\"active\">Active Incidents</option></select></div></div></div><div class=\"btn-group mb-3\" role=\"group\"><a id=\"login-button\" href=\"/ims/auth/login\" role=\"button\" class=\"btn btn-md btn-default btn-primary if-not-logged-in hidden\">Log In</a></div><div class=\"btn-group mb-3\" role=\"group\"><a href=\"/ims/auth/logout\" role=\"button\" class=\"btn btn-md btn-default btn-danger if-logged-in hidden\">Log Out</a></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
