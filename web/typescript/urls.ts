...
const url_directory = "/ims/api/directory";
const url_directoryPersons = "/ims/api/directory/persons";
const url_directoryPerson = "/ims/api/directory/persons/<person_id>";
const url_directoryPersonPassword = "/ims/api/directory/persons/<person_id>/password";
const url_directoryTeams = "/ims/api/directory/teams";
const url_directoryTeam = "/ims/api/directory/teams/<team_id>";
const url_directoryPositions = "/ims/api/directory/positions";
const url_directoryPosition = "/ims/api/directory/positions/<position_id>";
const url_incidentTypes = "/ims/api/incident_types";
const url_search = "/ims/api/search";
...
const url_incidentIncidentType = "/ims/api/events/<event_id>/incidents/<incident_number>/incident_types/<incident_type_id>";
const url_incidentLinkedIncident = "/ims/api/events/<event_id>/incidents/<incident_number>/linked_incidents/<linked_event_name>/<linked_incident_number>";
...
const url_viewVisitNumber = "/ims/app/events/<event_id>/visits/<number>";
const url_viewSearch = "/ims/app/search";
const url_viewSearchJS = "/ims/static/search.js";
