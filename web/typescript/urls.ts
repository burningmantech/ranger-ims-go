...
const url_stays = "/ims/api/events/<event_id>/stays";
const url_stayNumber = "/ims/api/events/<event_id>/stays/<stay_number>";
...
const url_viewStays ="/ims/app/events/<event_id>/stays";
